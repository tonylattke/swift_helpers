...
class Node {
    ...
    // Render Scene
    func render(commandQueue: MTLCommandQueue, depthStencilState: MTLDepthStencilState, pipelineState: MTLRenderPipelineState, drawable: CAMetalDrawable, renderPassDescriptor: MTLRenderPassDescriptor, parentModelViewMatrix: float4x4, projectionMatrix: float4x4){
